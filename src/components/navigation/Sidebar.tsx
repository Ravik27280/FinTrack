...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    ...
    ">
      {/* Header */}
      <div className="p-6 border-b border-gray-200/50 dark:border-slate-700/50 flex-shrink-0">
      ...
      {/* Footer */}
      <div className="p-4 border-t border-gray-200/50 dark:border-slate-700/50 flex-shrink-0">
