...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    ...
    ">
      {/* Header - Fixed height */}
      <div className="h-20 p-6 border-b border-gray-200/50 dark:border-slate-700/50 flex items-center flex-shrink-0">
      ...
      {/* Footer - Fixed height */}
      <div className="h-48 p-4 border-t border-gray-200/50 dark:border-slate-700/50 flex-shrink-0">
        <div className="space-y-2">
          ...
          {/* Settings Button */}
          <button className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-900 dark:hover:text-white transition-colors">
          ...
          <button 
            onClick={onLogout}
            className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-xl text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors"
          >
