    ...
    <div className="space-y-6">
          ...
          <Card key={insight.id} className="hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-300 hover:scale-105">
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/20 ${getIconColor(insight.type)}`}>
              ...
              {insight.actionText && (
                <Button 
                  variant="glass" 
                  className="w-full justify-between group hover:bg-blue-500/20 hover:border-blue-500/30"
                >
      ...
      <Card>
        <div className="text-center py-8">
          <div className="w-16 h-16 bg-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 backdrop-blur-md border border-white/20">
        ...
        <Card>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-red-400 font-medium">+15.2%</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-600 dark:text-gray-300">Food & Dining</span>
              <span className="text-red-400 font-medium">+28.5%</span>
            </div>
            <div className="flex justify-between items-center">
